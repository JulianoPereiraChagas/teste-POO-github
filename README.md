...
3. 🎭 Polimorfismo (Múltiplas Formas)
   A regra de negócios diz que cada cargo recebe uma porcentagem diferente de bônus. Usamos o polimorfismo para sobrescrever (anotação @Override) o método calcularBonus() nas classes filhas. Na classe Main, criamos um método único (exibirFolhaDePagamento) que aceita qualquer tipo de Funcionário, mas na hora de executar, o Java sabe exatamente qual cálculo aplicar dependendo do cargo daquela pessoa!
